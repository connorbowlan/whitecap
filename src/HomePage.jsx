  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <section className="mb-12">
        <h1 className="text-4xl font-bold mb-6 text-white bg-gradient-to-r from-blue-500 to-blue-700 p-4 rounded-lg shadow-xl">
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-gradient-to-r from-blue-500 to-blue-700 text-white p-4 rounded-lg shadow-xl">
      ...
      <section className="mb-12">
        ...
        <p className="mb-4 text-gray-700 bg-white bg-opacity-80 p-4 rounded-lg shadow-xl">
