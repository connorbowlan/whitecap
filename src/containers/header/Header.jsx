  ...
  <div className="whitecap__header section__padding" id="home">
    <div className="whitecap__header-content">
      ...
      <p>
        ...
        solutions, Whitecap is here to help you harness the power of natural gas
        for your needs. Experience the seamless integration of clean energy and
        maximize your energy efficiency with our tailored solutions.
      </p>
